...
#define BONUS_BISHOP_PAIR_MG    30
#define BONUS_BISHOP_PAIR_EG    50
#define BONUS_ROOK_SEMI_OPEN_MG 10
#define BONUS_ROOK_SEMI_OPEN_EG 10
#define BONUS_ROOK_OPEN_MG      20
#define BONUS_ROOK_OPEN_EG      20
#define BONUS_ROOK_ON_7TH_MG    25
#define BONUS_ROOK_ON_7TH_EG    35
...
/* 
 * PeSTO's Piece-Square Tables (Material + Positional)
 * [0] = Middle Game (MG), [1] = End Game (EG)
 */
static const int PESTO_TABLE[6][2][64] = {
/* ---------------- PAWN ---------------- */
{
  /* MG */
  {
